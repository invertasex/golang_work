...
const (
	TelegramService_CheckUser_FullMethodName = "/telegram.TelegramService/CheckUser"
)
...
func (c *telegramServiceClient) CheckUser(ctx context.Context, in *CheckUserRequest, opts ...grpc.CallOption) (*CheckUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckUserResponse)
	err := c.cc.Invoke(ctx, TelegramService_CheckUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTelegramServiceServer) CheckUser(context.Context, *CheckUserRequest) (*CheckUserResponse, error) {
...
func _TelegramService_CheckUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TelegramServiceServer).CheckUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TelegramService_CheckUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TelegramServiceServer).CheckUser(ctx, req.(*CheckUserRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _TelegramService_CheckUser_Handler,
		},
	},
